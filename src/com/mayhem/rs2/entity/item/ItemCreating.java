...
public enum ItemCreating {
	...
	FROZEN_WHIP("Frozen whip", new int[] { 12774 }, new int[] { 4151,  12769 }, new int[][] { }),
	...
	SILVERLIGHT("Darklight", new int[] { 6746 }, new int[] { 2402, 19677,19677,19677,19677,19677 }, new int[][] { {Skills.SMITHING, 91} }),
