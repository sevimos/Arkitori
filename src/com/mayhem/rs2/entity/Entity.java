...
import com.mayhem.core.task.impl.RegenerateSkillTask;
...
public abstract class Entity implements CombatInterface {
	...
	public static boolean inWilderness(int x, int y) {
		return (x > 2941 && x < 3392 && y > 3521 && y < 3966) || (x > 2941 && x < 3392 && y > 9918 && y < 10366) || (x > 1580 && x < 1658 && y > 3565 && y < 3656);
	}
	...
	public long getFreeze() {
		return (System.currentTimeMillis() - this.freeze)/-1000;
	...
	public boolean inArea(Area area, boolean heightSupport) {
		if (area == null)
			return false;
		if (heightSupport && (location.getZ() != (int) area.getZ()))
			return false;

		return (location.getX() >= area.getBottomX()) && (location.getX() <= area.getTopX())
				&& (location.getY() >= area.getBottomY()) && (location.getY() <= area.getTopY());
	}

	public boolean inArea(Area area, int heightOverride, boolean heightSupport) {
		if (area == null)
			return false;
		if (heightSupport && (location.getZ() != heightOverride))
			return false;
	...
	public boolean inMultiArea() {
		...
		int y = location.getY();
		int z = location.getZ();
		if (inArea(new Location(3281, 3157, 0), new Location(3304, 3179, 0), false)) {
			return true;
		}
		if (inArea(new Location(2686, 2690, 0), new Location(2825, 2816, 0), false)) {
			return true;
		}
		if (inArea(new Location(1680, 10090, 0), new Location(1710, 10110, 0), false)) {
			return true;
		}
		...
		if (inArea(new Location(3076, 9791, 0), new Location(3111, 9812, 0), true)) {//skotizo
			return true;
		}
		if (inArea(new Location(3020, 3297, 0), new Location(3044, 3314, 0), true)) {//event boss
			return true;
		}
		if (inArea(new Location(2738, 3411, 0), new Location(2765, 3440, 0), true)) {//event boss
			return true;
		}
		if (inArea(new Location(3179, 3141, 0), new Location(3220, 3180, 0), true)) {//event boss
			return true;
		}
		
		return x >= 2333 && y >= 3687 && x <= 2362 && y <= 3717 || x >= 1680 && y >= 10090 && x <= 1710 && y <= 10110 || x >= 3306 && y >= 9364 && x <= 3332 && y <= 9392 || ((x >= 2956) && (y >= 3714) && (x <= 3006) && (y <= 3750)) || ((x <= 2049) && (y <= 5251) && (x >= 1980) && (y >= 5178)) || ((x >= 2893) && (y >= 4430) && (x <= 2934) && (y <= 4471)) || ((x >= 1761) && (y >= 5337) && (x <= 1780) && (y <= 5370)) || ((x >= 3029) && (x <= 3374) && (y >= 3759) && (y <= 3903)) || ((x >= 2250) && (x <= 2280) && (y >= 4670) && (y <= 4720)) || ((x >= 3198) && (x <= 3380) && (y >= 3904) && (y <= 3970)) || ((x >= 3191) && (x <= 3326) && (y >= 3510) && (y <= 3759)) || ((x >= 2987) && (x <= 3006) && (y >= 3912) && (y <= 3930)) || ((x >= 2245) && (x <= 2295) && (y >= 4675) && (y <= 4720)) || ((x >= 3006) && (x <= 3071) && (y >= 3602) && (y <= 3710)) || ((x >= 3134) && (x <= 3192) && (y >= 3519) && (y <= 3646)) || ((z > 0) && (x >= 3460) && (x <= 3545) && (y >= 3150) && (y <= 3267)) || ((x >= 2369) && (x <= 2425) && (y >= 5058) && (y <= 5122))|| ((x >= 3241) && (y >= 9353) && (x <= 3256) && (y <= 9378)) || ((x >= 2914) && (y >= 4359) && (x <= 2972) && (y <= 4412));
	}
	...
	public boolean inWilderness() {
		int x = location.getX();
		int y = location.getY();
		return (x > 2941 && x < 3392 && y > 3521 && y < 3966) || (x > 2941 && x < 3392 && y > 9918 && y < 10366) || (x > 2583 && x < 2729 && y > 3255 && y < 3343) || (x > 1580 && x < 1658 && y > 3565 && y < 3656);
	}
