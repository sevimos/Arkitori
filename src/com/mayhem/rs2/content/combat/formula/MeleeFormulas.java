...
public class MeleeFormulas {
	...
	public static double getDefenceRoll(Entity attacking, Entity defending) {
		Player blocker = null;
		if (!defending.isNpc()) {
			blocker = com.mayhem.rs2.entity.World.getPlayers()[defending.getIndex()];
		} else {
	...
	public static double calculateBaseDamage(Player player) {
		...
		if (((helm != null) && (helm.getId() == 8921)) || ((helm != null) && (helm.getId() == 11864)) || ((helm != null) && (helm.getId() == 13263) && (defending.isNpc()) && (player.getSlayer().hasTask()))) {
			Mob m = com.mayhem.rs2.entity.World.getNpcs()[defending.getIndex()];
