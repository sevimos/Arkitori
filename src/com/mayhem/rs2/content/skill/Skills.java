package com.mayhem.rs2.content.skill;
...
public class Skills {
	...
	public static void declare() {
		...
		EXPERIENCE_RATES[PRAYER] = 75;
		EXPERIENCE_RATES[MAGIC] = 1;
		EXPERIENCE_RATES[COOKING] = 25;
		EXPERIENCE_RATES[WOODCUTTING] = 30;
		EXPERIENCE_RATES[FLETCHING] = 30;
		EXPERIENCE_RATES[FISHING] = 24;
		EXPERIENCE_RATES[FIREMAKING] = 30;
		EXPERIENCE_RATES[CRAFTING] = 30;
		EXPERIENCE_RATES[SMITHING] = 25;
		EXPERIENCE_RATES[MINING] = 35;
		EXPERIENCE_RATES[HERBLORE] = 35;
		EXPERIENCE_RATES[AGILITY] = 100;
		EXPERIENCE_RATES[THIEVING] = 30;
		EXPERIENCE_RATES[SLAYER] = 75;
		EXPERIENCE_RATES[HUNTER] = 15;
		EXPERIENCE_RATES[FARMING] = 50;
		EXPERIENCE_RATES[RUNECRAFTING] = 30;
		EXPERIENCE_RATES[DUNGEONEERING] = 40;
		EXPERIENCE_RATES[SUMMONING] = 40;
	}
