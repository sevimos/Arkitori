package com.mayhem.core.util.chance;
...
public class WeightedChance<T> implements WeightedObject<T> {
	...
	public static final double UNCOMMON = 5;
	public static final double RARE = .5;
	public static final double VERY_RARE = .10;
	public static final double LEGENDARY = 0.05;//0.50% Chance?
